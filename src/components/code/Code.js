...
function Code(){
    return(
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 md:w-2/3 m-auto mt-10 md:mt-20 p-10'>
            <div>
                <p className='text-[#0F1A2F] text-[58px] title_font font-bold tracking-wide'>QR Codes</p>
                <p className='text-[18px] text-gray-500 title_font'>Target your offline audience with branded QR Codes. Don't</p>
                <p className='text-[18px] text-gray-500 title_font'>print in vain - you can always change the destination.</p>
            ...
            <div className='mt-10 md:mt-0'>
                <img src='../../img/code-1.png' className='scale-125'/>
            </div>
        </div>
        {/* Text area */}
        <div className='w-full md:w-2/3 m-auto mt-40 md:mt-80 p-5'>
            ...
            <p className='text-gray-500 text-[18px] md:text-[20px]  text-center md:mt-4 title_font'>Generate customizable QR Codes for your brand. Dynamically manage the destination</p>
            <p className='text-gray-500 text-[18px] md:text-[20px]  text-center title_font'>behind without having to generate and print new codes.</p>
        </div>

        {/* Understand your visitors section */}
        <div className='grid grid-cols-1 md:grid-cols-2 md:w-2/3 m-auto mt-10 md:mt-10 p-5'>
            <div className='md:pt-40'>
                <p className='text-[#0F1A2F] text-[36px] title_font font-semibold'>Keep your QR Codes on brand</p>
                <p className='text-gray-500 text-[18px] title_font md:mt-2'>Use our editor to create beautiful looking QR codes that works with your brand.</p>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mt-2 md:mt-20'>
                    <div>
                        <img src='../../img/code-2.png' className='w-20 h-20'/>
                        <p className='text-[#0F1A2F] text-[22px] title_font font-semibold md:mt-5'>Style & shape</p>
                        <p className='text-gray-500 text-[18px] title_font md:mt-2'>Customize the style and shape of your QR Code.</p>
                    </div>

                    <div>
                        <img src='../../img/code-3.png'/>
                        <p className='text-[#0F1A2F] text-[22px] title_font font-semibold md:mt-5'>Color & logo</p>
                        <p className='text-gray-500 text-[18px] title_font md:mt-2'>Customize the color and add a logo to your QR code.</p>
                    </div>
                </div>
            </div>
            <div>
         ...
         <div className='grid grid-cols-1 gap-3 md:grid-cols-2 md:w-2/3 m-auto mt-10 md:mt-10 p-5'>
            <div className='md:pt-40'>
                <p className='text-[#0F1A2F] text-[36px] title_font font-semibold'>Easy to generate</p>
                <p className='text-gray-500 text-[18px] title_font md:mt-2'>Generate new QR Codes with a single click of a button. Customize to make it fit your brand in seconds.</p>
                <div>
                    <img src='../../img/code-5.png'/>
                </div>
            </div>
            
            <div className='md:pt-40'>
                <p className='text-[#0F1A2F] text-[36px] title_font font-semibold'>Dynamic destination</p>
                <p className='text-gray-500 text-[18px] title_font md:mt-2'>Once generated, you can update the destination, UTM tags, and metadata seamlessly.

</p>
                <div>
                    <img src='../../img/code-6.png'/>
                </div>
            </div>
        </div>
