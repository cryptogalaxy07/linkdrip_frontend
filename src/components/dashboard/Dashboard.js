            ...
            <>
                ...
                <div className='md:w-2/3 m-auto '>
                    ...
                    <div className='text-center mt-2 md:mt-5'>
                        <p className='text-[30px] md:text-[76px] text-[#0F1A2f] font-bold title_font'>The most sophisticated</p>
                        <p className=' text-[30px] md:text-[76px] text-[#9B7BF7] font-bold -mt-3 md:-mt-5 title_font'>link engagement tool</p>
                ...
                <div className='w-full md:w-2/3 m-auto'>
                    <p className='text-center text-[25px] md:text-[30px] text-wide text-gray-900 font-bold title_font'>Seamless <label className='text-[#9B7BF7]'>integrations</label> with</p>
                    ...
                    <div className='mt-5 text-center'>
                        <p className='text-gray-900 text-[22px] font-semibold title_font'>...and many more.</p>
                    </div>
                </div>

                {/* Simple yet text section */}
                <div className='w-full md:w-2/3 m-auto mt-20 md:mt-40'>
                    <p className='text-gray-900 text-[45px] md:text-[58px] font-semibold text-center title_font'>Simple , yet</p>
                    <p className='text-[#9B7BF7] text-[45px] md:text-[58px]  font-semibold text-center title_font'>Powerful features</p>
                </div>
                ...
                <div className='container grid grid-cols-1 md:px-20 md:grid-cols-4 mt-5 gap-2 m-auto md:2/3'>
                        <div className='p-6 '>
                            ...
                            <p className='mt-2 font-semibold text-[25px] text-gray-800 hover:text-[#9B7BF7] title_font'>QR Codes</p>
                            <p className='mt-5 font-semibold text-[22px] text-gray-600 title_font'>Target your offline audience with branded QR Codes.</p>
                        </div>

                        <div className='p-6 '>
                            <img src='./img/section-2.png' className='hover:scale-105 duration-300 ease-in-out'/>
                            <p className='mt-2 font-semibold text-[25px] text-gray-800 hover:text-[#9B7BF7] title_font'>Call-To-Action</p>
                        ...
                        <div className='p-6 '>
                            <img src='./img/section-3.png' className='hover:scale-105 duration-300 ease-in-out title_font'/>
                            <p className='mt-2 font-semibold text-[25px] text-gray-800 hover:text-[#9B7BF7] title_font' >A / B Testing</p>
                        ...
                        <div className='p-6 '>
                            ...
                            <p className='mt-2 font-semibold text-[25px] text-gray-800 title_font hover:text-[#9B7BF7]'>Link Rotation</p>
                            <p className='mt-5 font-semibold text-[22px] title_font text-gray-600'>Automatically rotate your target destination.</p>
                        </div>
                </div>
                ...
                <div className='w-full md:w-2/3 m-auto mt-20 md:mt-[450px]'>
                    <p className='text-gray-900 text-[45px] md:text-[58px] font-semibold text-center title_font'><label className='text-[#9B7BF7] title_font'>Call-To-Actions</label> overlay</p>
                    <p className='text-gray-500 text-[18px] md:text-[20px]  font-semibold text-center md:mt-4 title_font'>LinkDrip allows you to add your own overlays to the destination site.</p>
                    <p className='text-gray-500 text-[18px] md:text-[20px]  font-semibold text-center title_font'>Pick between buttons, forms and greetings as <label className='text-18px md:text-[20px]'>Call-To-Actions in your brand.</label></p>
                </div>
                {/* number section */}
                <div className='w-full md:w-2/3 grid grid-col-1 md:grid-cols-2 m-auto  p-2'>
                    <div className='text-center m-auto'>
                        <div className='flex items-center md:mt-10 gap-2 hover:scale-105 duration-500 ease-in-out border rounded-lg py-10 px-4'>
                            ...
                            <p className='text-gray-700 font-semibold  text-[26px] title_font'>Create your own Call-To-Action</p>
                        </div>
                        <div className='flex items-center md:mt-10 gap-2 hover:scale-105 duration-500 ease-in-out border rounded-lg py-10 px-4'>
                            <div className='w-10 h-10 md:w-12 md:h-12 bg-[#9B7BF7] rounded-full text-white font-semibold  text-[24px] md:pt-1'>2.</div>
                            <p className='text-gray-700 font-semibold  text-[26px] title_font'>Add it to your destination site</p>
                        </div>
                        <div className='flex items-center md:mt-10 gap-2 hover:scale-105 duration-500 ease-in-out border rounded-lg py-10 px-4'>
                            <div className='w-10 h-10 md:w-12 md:h-12 bg-[#9B7BF7] rounded-full text-white font-semibold  text-[24px] md:pt-1'>3.</div>
                            <p className='text-gray-700 font-semibold  text-[26px] title_font'>Share & Start tracking results</p>
                        </div>
                    </div>
                ...
                {/* Simple yet text section */}
                <div className='w-full md:w-2/3 m-auto mt-20 md:mt-40'>
                    <p className='text-gray-900 text-[45px] md:text-[58px] font-semibold text-center title_font'>Customize your links</p>
                    <p className='text-gray-500 text-[18px] md:text-[20px]  font-semibold text-center md:mt-4 title_font'>Besides shortening your link, you have the ability to fully</p>
                    <p className='text-gray-500 text-[18px] md:text-[20px]  font-semibold text-center title_font'>customize the link's metadata.</p>
                    <p className='text-gray-500 text-[18px] md:text-[20px]  font-semibold text-center md:mt-4 title_font'>Make sure the image, title, and description fits perfectly.</p>
                </div>
                {/* Metadata Section */}
                <div className='w-full md:w-2/3 grid grid-col-1 md:grid-cols-2 m-auto md:mt-20 p-2'>
                    ...
                    <div className='text-center m-auto'>
                        <div className='md:mt-10   rounded-lg px-4'>
                            <p className='text-[28px] md:text-[35px] text-gray-700 text-left font-semibold title_font'>Make sure your link looks</p>
                            <p className='text-[28px] md:text-[35px] md:-mt-4 text-gray-700 text-left font-semibold title_font'>great on social media</p>
                            <p className='text-[15px] md:text-[18px]  text-gray-500 text-left font-semibold title_font'>Change how your link will appear on social media and</p>
                            <p className='text-[15px] md:text-[18px]  text-gray-500 text-left font-semibold title_font'> in article embeds in a few simple steps.</p>
                        </div>
                        <div className='flex items-center md:mt-2 gap-3   rounded-lg py-10 px-4'>
                            <img src='./img/metadata-1.png'/>
                            <div>
                                <p className='text-gray-700 font-semibold  text-[26px] text-left title_font'>Custom OG Image</p>
                                <p className='text-gray-500 font-semibold  text-[18px] text-left title_font'>Add a custom OG image to your link.</p>
                                <p className='text-gray-500 font-semibold  text-[18px] text-left title_font'>It won't conflict with the destination link.</p>
                            </div>
                        </div>
                        <div className='flex items-center md:mt- gap-3   rounded-lg py-10 px-4'>
                            <img src='./img/metadata-2.png'/>
                            <div>
                                <p className='text-gray-700 font-semibold  text-[26px] text-left title_font'>Custom title & description</p>
                                <p className='text-gray-500 font-semibold  text-[18px] text-left title_font'>Add a custom title and discription.</p>
                                <p className='text-gray-500 font-semibold  text-[18px] text-left title_font'>It won't conflict with the destination link.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div className='w-full md:w-2/3 grid grid-col-1 md:grid-cols-2 m-auto md:mt-20 p-2'>
                    <div className='text-center m-auto'>
                        <div className='md:mt-10   rounded-lg px-4'>
                            <p className='text-[28px] md:text-[35px] text-gray-700 text-left font-semibold title_font'>Build UTM tags directly</p>
                            <p className='text-[28px] md:text-[35px] md:-mt-4 text-gray-800 text-left font-semibold title_font'>into the link</p>
                            <p className='text-[15px] md:text-[18px]  text-gray-500 text-left font-semibold title_font'>Make it easy to keep analytics organized for the</p>
                            <p className='text-[15px] md:text-[18px]  text-gray-500 text-left font-semibold title_font'>destination link, by including UTM tags in it.</p>
                        </div>
                        <div className='flex items-center md:mt-2 gap-3   rounded-lg py-10 px-4'>
                            <img src='./img/metadata-3.png'/>
                            <div>
                                <p className='text-gray-700 font-semibold  text-[26px] text-left title_font'>Easy interface to manage tags</p>
                                <p className='text-gray-500 font-semibold  text-[18px] text-left title_font'>Don't worry about the right URL syntax.</p>
                                <p className='text-gray-500 font-semibold  text-[18px] text-left title_font'>LinkDrip features a convenient UI.</p>
                            </div>
                        </div>
                        <div className='flex items-center md:mt- gap-3   rounded-lg py-10 px-4'>
                            <img src='./img/metadata-4.png'/>
                            <div>
                                <p className='text-gray-700 font-semibold  text-[26px] text-left title_font'>UTM Templates</p>
                                <p className='text-gray-500 font-semibold  text-[18px] text-left title_font'>Save and reuse your UTM templates</p>
                                <p className='text-gray-500 font-semibold  text-[18px] text-left title_font'>across campaigns. This is a big time saver.</p>
                            </div>
                        </div>
                    </div>
                    <div className='m-auto'>
                ...
                {/* Simple yet text section */}
                <div className='w-full md:w-2/3 m-auto mt-20 md:mt-40'>
                    <p className='text-gray-900 text-[45px] md:text-[58px] font-semibold text-center title_font'>Advanced <label className='text-[#9B7BF7]'>use cases</label></p>
                    <p className='text-gray-500 text-[18px] md:text-[20px]  font-semibold text-center md:mt-4 title_font'>LinkDrip supports a set of advanced use cases, such as adding your custom domain, injecting custom</p>
                    <p className='text-gray-500 text-[18px] md:text-[20px]  font-semibold text-center title_font'>JavaScript into your link, and using the LinkDrip Pixel.</p>
                </div>
                ...
                <div className='w-full md:w-2/3 m-auto grid grid-cols-1 place-items-center md:grid-cols-3 px-20 mt-10 md:mt-10'>
                    <div className='flex items-center gap-2 hover:scale-105 duration-700 ease-in-out  md:mt-0'>
                        ...
                        <div>
                            <p className='text-gray-700  text-[18px] md:text-[20px] font-semibold title_font'>Custom domain</p>
                        </div>
                    </div>
                    ...
                    <div className='flex items-center gap-2 hover:scale-105 duration-700 ease-in-out mt-5 md:mt-0'>
                        ...
                        <div>
                            <p className='text-gray-700  text-[18px] md:text-[20px] font-semibold title_font'>Custom scripts</p>
                        </div>
                    </div>
                    ...
                    <div className='flex items-center gap-2 hover:scale-105 duration-700 ease-in-out mt-5 md:mt-0'>
                        ...
                        <div>
                            <p className='text-gray-700  text-[18px] md:text-[20px] font-semibold title_font'>LinkDrip Pixel</p>
                        </div>
                    </div>
                </div>
                ...
                <div className='w-full md:w-2/3 grid grid-col-1 md:px-20 md:grid-cols-2 m-auto md:mt-40 p-2'>
                    <div className='text-center md:pl-20'>
                        <div className='rounded-lg px-4'>
                            <img src='./img/domain-1.png'/>
                            <p className='text-[28px] md:text-[35px] text-gray-700 text-left font-semibold title_font'>Build UTM tags directly</p>
                            <p className='text-[28px] md:text-[35px] md:-mt-4 text-gray-700 text-left font-semibold title_font'>into the link</p>
                            <p className='text-[15px] md:text-[18px]  text-gray-500 text-left font-semibold title_font'>Make it easy to keep analytics organized for the</p>
                            <p className='text-[15px] md:text-[18px]  text-gray-500 text-left font-semibold title_font'>destination link, by including UTM tags in it.</p>
                        </div>
                    </div>
                ...
                <div className='w-full md:w-2/3 m-auto mt-20 md:mt-40 title_font'>
                    <p className='text-gray-900 text-[45px] md:text-[58px] font-semibold text-center title_font'>The LinkDrip <label className='text-[#9B7BF7]'>Blog</label></p>
                    <p className='text-gray-500 text-[18px] md:text-[20px]  font-semibold text-center md:mt-4 title_font'>Learn everything about building your brand through intentional link engagement</p>
                    <p className='text-gray-500 text-[18px] md:text-[20px]  font-semibold text-center title_font'>building.</p>
                </div>
                ...
                <div className='md:w-2/3 m-auto grid grid-cols-1 md:grid-cols-3 p-5 md:p-0 md:mt-10'>
                    ...
                    <div class="max-w-sm bg-white rounded-3xl shadow-md border">
                            ...
                            <div className='relative flex items-center left-[30px] -top-[60px]'>
                                <p className='text-[#9B7BF7] font-bold px-3 py-3 bg-[rgb(232,240,255)] rounded-xl title_font'>Marketing</p>
                                <p className='text-gray-600 font-semibold title_font'>Oct 18 , 2022</p>
                            </div>                        
                        <div class="px-5 pb-5">
                            <a href="#">
                                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-800 hover:text-[#9B7BF7] title_font">50+ Powerful Call to Action Phrases to Help Boost Your Conversions</h5>
                            </a>
                            <p class="mb-3  text-gray-500 text-xl font-semibold title_font">In this blog post, we will discuss 50 powerful call to action phrases that you can use on your website!</p>
                            <a href="#" class="inline-flex items-center py-2 px-3 title_font text-xl font-medium text-center text-[#9B7BF7] ">
                                Read more
                    ...
                    <div class="max-w-sm bg-white rounded-3xl shadow-md border">
                        ...
                        <div class="px-5 pb-5">
                            ...
                            <p class="mb-3  text-gray-500 text-xl font-semibold title_font">In this blog post, we will discuss 50 powerful call to action phrases that you can use on your website!</p>
                            <a href="#" class="inline-flex items-center title_font py-2 px-3 text-xl font-medium text-center text-[#9B7BF7] ">
                                Read more
                                <svg aria-hidden="true" class="ml-2 -mr-1 w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                            </a>
                        </div>
                ...
                <div className='grid place-items-center mt-40'>
                    <button className='w-[92%] md:w-auto border title_font border-gray-200  text-gray-60 bg-white  px-20 md:px-14 py-4 md:py-6 rounded-md text-[18px]  hover:text-white hover:scale-105 hover:bg-[#ED64A6] duration-500 ease-in-out'>Browse all articles</button>
                </div>
                ...
                <div className='w-full bg-[#9B7BF7] mt-20 md:mt-40 md:px-80 h-[600px] md:h-[700px]'>
                    <div className='grid grid-cols-1 md:grid-cols-2 md:pt-40'>
                        <div className='p-2'>
                            <p className='text-white text-[45px] md:text-[58px] font-semibold text-left title_font'>Start sharing your </p>
                            <p className='text-white text-[45px] md:text-[58px] font-semibold text-left title_font'>links In a new way</p>
                            <button className='w-[92%] mt-10 text-center md:mt-5 md:w-auto border md:text-left title_font border-gray-200 font-bold text-[#9B7BF7] bg-white  px-20 md:px-14 py-4 md:py-6 rounded-md text-[18px]  hover:text-white hover:scale-105 hover:bg-[#ED64A6] duration-500 ease-in-out'>Get Early Access</button>
                        </div>
                        <div>
