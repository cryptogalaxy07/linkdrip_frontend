        ...
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:w-2/3 m-auto mt-10 md:mt-20 p-10">
                <div>
                    ...
                    <p className="text-[18px] text-gray-500 title_font">
                        Observe and analyse your links performance in real-time.
                    </p>
                    <p className="text-[18px] text-gray-500 title_font">
                        From referrer, device, to the local city of the visitor.
                    </p>
            ...
            <div className="w-full md:w-2/3 m-auto mt-40 md:mt-80 p-5">
                ...
                <p className="text-gray-500 text-[18px] md:text-[20px]  text-center md:mt-4 title_font">
                    Track and analyze the performance of your links from one
                    place. You can skip the
                </p>
                <p className="text-gray-500 text-[18px] md:text-[20px]  text-center title_font">
                    spreadsheets and tedious note-taking.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:w-2/3 m-auto mt-10 md:mt-10 p-5">
                <div className="md:pt-40">
                    ...
                    <p className="text-gray-500 text-[18px] title_font md:mt-2">
                        We give you real-time insight into the visitors of your
                        links.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2 md:mt-20">
                        <div>
                            ...
                            <p className="text-gray-500 text-[18px] title_font md:mt-2">
                                Are your visitors on a desktop, tablet, mobile,
                                TV or other smart devices? We'll show you.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 text-[18px] title_font md:mt-2">
                                Are your visitors using Chrome, Edge, Firefox or
                                Safari? You can easily see this with LinkDrip.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2 md:w-2/3 m-auto mt-10 md:mt-10 p-5">
                <div className="md:pt-40">
                    ...
                    <p className="text-gray-500 text-[18px] title_font md:mt-2">
                        Pinpoint where your links visitors are coming from. List
                        the top referrers across your links.
                    </p>
                    <div>
                ...
                <div className="md:pt-40">
                    ...
                    <p className="text-gray-500 text-[18px] title_font md:mt-2">
                        Spot where your visitors are located. All the way down
                        to local city level.
                    </p>
                    <div>
