        ...
        <>
            ...
            <div className="w-full md:w-2/3 m-auto mt-40 md:mt-80 p-5">
                ...
                <p className="text-gray-500 text-[18px] md:text-[20px]  text-center md:mt-4 title_font">
                    ...
                    <p className="text-gray-500 text-[18px] md:text-[20px]  text-center title_font">
                        LinkDrip makes it easy to A/B test your website with
                        multiple destination variants.LinkDrip makes it easy to
                        A/B test your website with multiple destination
                        variants.
                    </p>
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:w-2/3 m-auto mt-10 md:mt-10 p-5">
                <div className="md:pt-40">
                    ...
                    <p className="text-gray-500 text-[18px] title_font md:mt-2">
                        No client-side "blinking" or "glitching". LinkDrip will
                        roll the dice and determine a variant before redirecting
                        the viewer to your destination.{" "}
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2 md:mt-20">
                        <div>
                            ...
                            <p className="text-gray-500 text-[18px] title_font md:mt-2">
                                No JavaScript required on the client. The viewer
                                will have a seemless, smooth and lightning fast
                                redirect.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 text-[18px] title_font md:mt-2">
                                LinkDrip remembers the destination for each
                                viewer so they'll get the same result each time
                                they revisit the link.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2 md:w-2/3 m-auto mt-10 md:mt-10 p-5">
                <div className="md:pt-40">
                    ...
                    <p className="text-gray-500 text-[18px] title_font md:mt-2">
                        Track conversions across all variants from one place by
                        installing the LinkDrip pixel on your destination site.
                    </p>
                    <div>
                ...
                <div className="md:pt-40">
                    ...
                    <p className="text-gray-500 text-[18px] title_font md:mt-2">
                        Set a time and date for the A/B test to finish, and
                        LinkDrip will automatically pick the winner for all
                        future redirects.
                    </p>
                    <div>
