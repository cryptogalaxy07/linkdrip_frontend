...
function Rotation(){
    return(
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 md:w-2/3 m-auto mt-10 md:mt-20 p-10'>
            <div>
                <p className='text-[#0F1A2F] text-[58px] title_font font-bold tracking-wide'>Link rotation</p>
                <p className='text-[18px] text-gray-500 title_font'>Automatically rotate your target destination on a schedule</p>
                <p className='text-[18px] text-gray-500 title_font'>or given performance conditions.</p>
        ...
        <div className='w-full md:w-2/3 m-auto mt-40 md:mt-80 p-5'>
            ...
            <p className='text-gray-500 text-[18px] md:text-[20px]  text-center md:mt-4 title_font'>LinkDrip will automatically rotate your target destination based on a time and date, or</p>
            <p className='text-gray-500 text-[18px] md:text-[20px]  text-center title_font'>when the link reached a certain number of clicks or visitors.</p>
        </div>

        {/* Understand your visitors section */}
        <div className='grid grid-cols-1 md:grid-cols-2 md:w-2/3 m-auto mt-10 md:mt-10 p-5'>
            <div className='md:pt-40'>
                <p className='text-[#0F1A2F] text-[36px] title_font font-semibold'>Give your visitors a dynamic experience</p>
                <p className='text-gray-500 text-[18px] title_font md:mt-2'>Let your links change dynamically, either on a repeated rotation, or by shuffling through your links.</p>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mt-2 md:mt-20'>
                    <div>
                        <img src='../../img/rotation-2.png'/>
                        <p className='text-[#0F1A2F] text-[22px] title_font font-semibold md:mt-5'>Repeat</p>
                        <p className='text-gray-500 text-[18px] title_font md:mt-2'>After a full rotation - your links will start over.</p>
                    </div>

                    <div>
                        <img src='../../img/rotation-3.png'/>
                        <p className='text-[#0F1A2F] text-[22px] title_font font-semibold md:mt-5'>Shuffle</p>
                        <p className='text-gray-500 text-[18px] title_font md:mt-2'>Shuffle through your links at a given schedule or condition.</p>
                    </div>
                </div>
            </div>
            <div>
                <img src='../../img/rotation-4.png'/>
            </div>
        </div>
         ...
         <div className='grid grid-cols-1 gap-3 md:grid-cols-2 md:w-2/3 m-auto mt-10 md:mt-10 p-5'>
            <div className='md:pt-40'>
                <p className='text-[#0F1A2F] text-[36px] title_font font-semibold'>Rotation triggers</p>
                <p className='text-gray-500 text-[18px] title_font md:mt-2'>Set up rotation triggers to change the target destination given a number of clicks or unique visits.</p>
                <div>
                    <img src='../../img/rotation-5.png'/>
                </div>
            </div>
            
            <div className='md:pt-40'>
                <p className='text-[#0F1A2F] text-[36px] title_font font-semibold'>Link expiration</p>
                <p className='text-gray-500 text-[18px] title_font md:mt-2'>Schedule your link to expire at a given time and date, or after a given number of clicks.</p>
                <div>
                    <img src='../../img/rotation-6.png'/>
                </div>
            </div>
        </div>
