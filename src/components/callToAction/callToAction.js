...
function CallToAction(){
    return(
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 md:w-2/3 m-auto mt-10 md:mt-20 p-10'>
            <div>
                <p className='text-[#0F1A2F] text-[58px] title_font font-bold tracking-wide'>Call-To-Action</p>
                <p className='text-[18px] text-gray-500 title_font font-semibold'>Add a custom Call-To-Action overlay on your destination</p>
                <p className='text-[18px] text-gray-500 title_font '>site. Customize branding, logo, colors, call-to-action and</p>
                <p className='text-[18px] text-gray-500 title_font '>much more.</p>
            ...
            <div className='mt-10 md:mt-0'>
                <img src='../../img/callToAction-1.png' className='scale-125'/>
            </div>
        </div>
        {/* Text area */}
        <div className='w-full md:w-2/3 m-auto mt-40 md:mt-80 p-5'>
            ...
            <p className='text-gray-500 text-[18px] md:text-[20px]  text-center md:mt-4 title_font'>LinkDrip lets you create a custom Call-To-Action which will overlay the site you are</p>
            <p className='text-gray-500 text-[18px] md:text-[20px]  text-center title_font'>redirecting to.</p>
        </div>

        {/* Understand your visitors section */}
        <div className='grid grid-cols-1 md:grid-cols-2 md:w-2/3 m-auto mt-10 md:mt-10 p-5'>
            <div className='md:pt-40'>
                <p className='text-[#0F1A2F] text-[36px] title_font font-semibold'>Convert 79% better with custom CTAs.</p>
                <p className='text-gray-500 text-[18px] title_font md:mt-2'>A customer Call-To-Action overlay is known to convert up to 79% better.</p>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mt-2 md:mt-20'>
                    <div>
                        <img src='../../img/callToAction-4.png'/>
                        <p className='text-[#0F1A2F] text-[22px] title_font font-semibold md:mt-5'>Add your own logo + branding</p>
                        <p className='text-gray-500 text-[18px] title_font md:mt-2'>Upload your own logo and add to the Call-To-Action.</p>
                    </div>

                    <div>
                        <img src='../../img/callToAction-3.png'/>
                        <p className='text-[#0F1A2F] text-[22px] title_font font-semibold md:mt-5'>Customize the Call-To-Action</p>
                        <p className='text-gray-500 text-[18px] title_font md:mt-2'>Pick between a broad range of CTA types, colors and styles.</p>
                    </div>
                </div>
            </div>
            <div>
                <img src='../../img/callToAction-5.png'/>
            </div>
        </div>
         ...
         <div className='grid grid-cols-1 gap-3 md:grid-cols-2 md:w-2/3 m-auto mt-10 md:mt-10 p-5'>
            <div className='md:pt-40'>
                <p className='text-[#0F1A2F] text-[36px] title_font font-semibold'>CTA Buttons</p>
                <p className='text-gray-500 text-[18px] title_font md:mt-2'>Add a CTA button on top of your targeted site and drive visitors to your landing page.</p>
                <div>
                    <img src='../../img/callToAction-6.png'/>
                </div>
            </div>
            
            <div className='md:pt-40'>
                <p className='text-[#0F1A2F] text-[36px] title_font font-semibold'>CTA Forms</p>
                <p className='text-gray-500 text-[18px] title_font md:mt-2'>Capture the visitor's email directly from your targeted site without the need to leave and come back.</p>
                <div>
                    <img src='../../img/callToAction-7.png'/>
                </div>
            </div>
        </div>
