...
function Retarget(){
    return(
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 md:w-2/3 m-auto mt-10 md:mt-20 p-10'>
            <div>
                <p className='text-[#0F1A2F] text-[58px] title_font font-bold tracking-wide'>Inbuilt </p>
                <p className='text-[#0F1A2F] text-[58px] md:-mt-5 title_font font-bold tracking-wide'>retargeting</p>   
                <p className='text-[18px] text-gray-500 title_font '>Retarget your visitors with ads on Facebook, LinkedIn,</p>
                <p className='text-[18px] text-gray-500 title_font '>YouTube, Google and many more.</p>
        ...
        <div className='w-full md:w-2/3 m-auto mt-40 md:mt-80 p-5'>
            ...
            <p className='text-gray-500 text-[18px] md:text-[20px]  text-center md:mt-4 title_font'>Supercharge your ads! With LinkDrip's inbuilt retargeting, it has never been easier to</p>
            <p className='text-gray-500 text-[18px] md:text-[20px]  text-center title_font'>run targeted ad campaigns for prospects who have shown interest.</p>
        </div>

        {/* Understand your visitors section */}
        <div className='grid grid-cols-1 md:grid-cols-2 md:w-2/3 m-auto mt-10 md:mt-10 p-5'>
            <div className='md:pt-40'>
                <p className='text-[#0F1A2F] text-[36px] title_font font-semibold'>Target the right prospects</p>
                <p className='text-gray-500 text-[18px] title_font md:mt-2'>Build supertargeted audiences down to the specific link.</p>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mt-2 md:mt-20'>
                    <div>
                        <img src='../../img/retarget-2.png'/>
                        <p className='text-[#0F1A2F] text-[22px] title_font font-semibold md:mt-5'>Pixel & tags</p>
                        <p className='text-gray-500 text-[18px] title_font md:mt-2'>Add your pixel or tag ID - and we will take care of tracking your visitors.</p>
                    </div>

                    <div>
                        <img src='../../img/retarget-3.png'/>
                        <p className='text-[#0F1A2F] text-[22px] title_font font-semibold md:mt-5'>UTM builder</p>
                        <p className='text-gray-500 text-[18px] title_font md:mt-2'>Build UTM tags into your links easily using our link builder tool.</p>
                    </div>
                </div>
            </div>
            <div>
         ...
         <div className='grid grid-cols-1 gap-3 md:grid-cols-2 md:w-2/3 m-auto mt-10 md:mt-10 p-5'>
            <div className='md:pt-40'>
                <p className='text-[#0F1A2F] text-[36px] title_font font-semibold'>Custom events</p>
                <p className='text-gray-500 text-[18px] title_font md:mt-2'>Extend your pixel/tag functionality with custom conversion events.</p>
                <div>
            ...
            <div className='md:pt-40'>
                <p className='text-[#0F1A2F] text-[36px] title_font font-semibold'>Your favorite ad platforms</p>
                <p className='text-gray-500 text-[18px] title_font md:mt-2'>Use your pixel/tag from all major ad platforms - with a single click of a button.</p>
                <div>
